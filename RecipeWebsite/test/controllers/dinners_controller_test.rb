...
class DinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dinner" do
    assert_difference('Dinner.count') do
      post dinners_url, params: { dinner: { host: @dinner.host, image: @dinner.image, ingredients: @dinner.ingredients, instructions: @dinner.instructions, title: @dinner.title, total_time: @dinner.total_time, yields: @dinner.yields } }
    end
  ...
  test "should update dinner" do
    patch dinner_url(@dinner), params: { dinner: { host: @dinner.host, image: @dinner.image, ingredients: @dinner.ingredients, instructions: @dinner.instructions, title: @dinner.title, total_time: @dinner.total_time, yields: @dinner.yields } }
